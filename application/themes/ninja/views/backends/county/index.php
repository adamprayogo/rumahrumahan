	...
	$('.search-query').keypress(function(e) {
		...
		if (code == 13) {
			...
			if (q != "") {
				location.href ="<?php echo base_url().'admin/county/search';?>?query=" + q;
			}
		}
	})
	</script>
				...
				<tbody>
					...
					foreach($list as $r){
						...
						<tr>
							...
							<td><a class="btn btn-info"  href="<?php echo base_url().'admin/county/edit?id='.$r->id;?>"><?php echo lang('msg_edit');?></a></td>
