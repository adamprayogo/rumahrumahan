		...
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-xs-10">
					...
					<div class="checkbox">
						<label>
							<input type="checkbox" name="is_menu" value="<?php echo IS_MENU; ?>"> <?php echo lang('msg_is_menu'); ?>
						</label>
					</div>
			...
			<div class="form-group">
				...
				<div class="col-xs-10">
					<input type="text" id="slug" name="slug" class="form-control" value="<?php echo set_value('slug') ?>" placeholder="<?php echo lang('msg_slug'); ?>" >
			...
			<div class="form-group">
				...
				<div class="col-xs-10">
					<textarea class="form-control" rows="10" name="keyword"  placeholder="<?php echo lang('msg_keywords'); ?>"><?php echo set_value('keyword') ?></textarea>
			...
			<div class="form-group">
				...
				<div class="col-xs-10">
					<textarea class="form-control" rows="10" name="description" placeholder="<?php echo lang('msg_description'); ?>"><?php echo set_value('description') ?></textarea>
			...
			<div class="form-group">
				...
				<div class="col-xs-10">
					<textarea class="form-control" rows="10" id="content"  name="content" placeholder="<?php echo lang('msg_content'); ?>"><?php echo set_value('content') ?></textarea>
