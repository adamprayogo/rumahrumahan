...
<form class="form-horizontal" id="form" method="post" action="" enctype="multipart/form-data">
	<fieldset>
		<input type="hidden" name="id" class="id" value="<?php echo $obj['currency_id']; ?>"/>
		<div class="form-group">
			...
			<div class="col-xs-10">
				<select name="currency" class="form-control">
					...
					foreach($list as $r){
						?>
						<option id="<?php echo $r->id; ?>" value="<?php echo $r->currency_symbol;?>" <?php if($r->id==$obj['currency_id']){echo 'selected';} ?> ><?php echo $r->currency_code;?>&nbsp;(<?php echo $r->name;?>)</option>
						<?php }?>
					</select>
				</div>
			</div>
