...
<div class="page-header controls-wrapper">
	<a href="<?php echo base_url().'admin/top_slider/create';?>" class="btn btn-primary"><?php echo lang('msg_add');?></a>
...
$('.search-query').keypress(function(e) {
	...
	if (code == 13) {
		...
		if (q != "") {
			location.href ="<?php echo base_url().'admin/top_slider/search';?>?query=" + q;
		}
	}
})
</script>
			...
			<tbody>
				...
				foreach($list as $r){
					...
					<tr>
						...
						?></td>
						<!-- <td><a class="btn btn-info"  href="<?php //echo base_url().'admin/top_slider/edit?id='.$r->id;?>"><?php //echo lang('msg_edit');?></a></td> -->
						<!-- 	<td></td> -->
						...
						<td>
							<div class="btn-group">
								...
								<ul class="dropdown-menu">
									<li>
										<a href="<?php echo base_url().'admin/top_slider/activate?id='.$r->id;?>">
											<?php echo lang('msg_activate');?>
										</a>
									</li>
									<li>
										<a href="<?php echo base_url().'admin/top_slider/deactivate?id='.$r->id;?>">
											<?php echo lang('msg_deactivate');?>
										</a>
									</li>

									<li>
										<a href="<?php echo base_url().'admin/top_slider/edit?id='.$r->id;?>">
											<?php echo lang('msg_edit');?>
										</a>
									</li>

									<li>
										<a  href="<?php echo base_url().'admin/top_slider/delete?id='.$r->id;?>" onclick="return confirm('<?php echo lang('msg_confirm_delete');?>')"><?php echo lang('msg_delete');?></a>
									</li>
								</ul>
							</div>
						</td>
