	...
	<form class="form-horizontal" id="form" method="post" action="" enctype="multipart/form-data">
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-xs-10">
					<input type="text" id="skype" class="form-control" name="skype" value="<?php echo set_value('skype');?>">
			...
			<div class="form-group">
				...
				<div class="col-xs-10">
					<select name="perm" class="form-control">
					    <option value="<?php echo USER;?>"><?php echo lang('msg_user');?></option>
						<option value="<?php echo AGENT;?>"><?php echo lang('msg_agent');?></option>
